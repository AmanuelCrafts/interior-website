            ...
            <div>
              <Switch
                ...
                className={classNames(
                  ...
                  "flex w-8 flex-none cursor-pointer rounded-full p-px right-1 ring-inset ring-gray-950/5 transition-colors duration-200 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
                )}
              >
